...
import { Mail, ArrowLeft, Key, Loader2, CheckCircle2, Sparkles } from 'lucide-react';
import { useAuth } from '@/contexts/AuthContext';

type EmailMode = 'select' | 'otp' | 'magic_link' | 'verify_otp' | 'sent' | 'success';

export function EmailAuthForm({ onBack }: { onBack: () => void }) {
  const { loginWithEmailOTP, verifyEmailOTP, loginWithMagicLink } = useAuth();
